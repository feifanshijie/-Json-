...
<head>
    ...
    <link rel="stylesheet" href="{{ '/gui/css/btn.css' }}">
    <link rel="stylesheet" href="{{ '/gui/css/gui.css' }}">
    <link rel="stylesheet" href="{{ '/gui/css/label.css' }}">
    {{--<script xmlns="http://www.w3.org/1999/xhtml" type="application/javascript" src="chrome://browser/content/feeds/subscribe.js"></script>--}}
